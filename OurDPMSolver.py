...
class NoiseScheduleVP:
    def __init__(
        ...
        if schedule not in ['discrete']:
            raise ValueError("Unsupported noise schedule {}. The schedule needs to be 'discrete'".format(schedule))
...
def model_wrapper(
    ...
    assert model_type in ["noise"]
    assert guidance_type in ["uncond"]
    return model_fn
...
class DPM_Solver:
    def __init__(
        ...
        assert algorithm_type in ["dpmsolver"]
